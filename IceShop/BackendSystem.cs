...
namespace IceShop
{
    public partial class BackendSystem : Form
    {
        ...
        void DisplayShoppingProduct(int myId)
        {
            ...
            // 最後的查詢，用於計算商品種類數量
            string countSQL = "select COUNT(DISTINCT oi.ProductId) as ProductCount " +
                  "from OrderItem oi where oi.OrderNumber = @OrderNumber;";
